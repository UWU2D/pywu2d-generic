...
from public.inputservice import IInputService
from core.keystack import KeyStack
...
class InputService(IInputService):
    ...
    def initialize(self, event_service):
        event_service.register_event(pygame.KEYDOWN, self.on_event)
        event_service.register_event(pygame.KEYUP, self.on_event)
        event_service.register_event(pygame.MOUSEMOTION, self.on_event)
        event_service.register_event(pygame.MOUSEBUTTONUP, self.on_event)
        event_service.register_event(pygame.MOUSEBUTTONDOWN, self.on_event)
